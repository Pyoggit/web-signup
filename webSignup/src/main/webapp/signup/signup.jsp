...
<body>
	<div class="signup-form">
        <h1>회원가입</h1>
        <form action="${pageContext.request.contextPath}/registerServlet.do" method="post" name="signup">
            <div class="int-area">
            ...
            <div class="int-area">
                ...
                <div class="birth-container">
                    <input type="text" name="year" id="year" placeholder="년 (YYYY)" maxlength="4" required>
            ...
            <div class="int-area">
                ...
                <div class="phone-container">
                    <input type="text" name="phone1" id="phone1" placeholder="010" maxlength="3" required>
                    <span>-</span>
