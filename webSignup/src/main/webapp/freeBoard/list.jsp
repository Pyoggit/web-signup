...
<%
    ...
    int number = 0;
    ArrayList<FreeBoardVO> boardList = null;
...
<link rel="stylesheet" href="${pageContext.request.contextPath}/freeBoard/css/list.css">
...
<main class="list-container">
    ...
    <table class="list-table">
        <tr>
            <td colspan="5" align="left" class="list-title">자유게시판 (전체 글: <%= count %>)</td>
        ...
        <!-- 게시글 데이터 -->
        <%
            for (FreeBoardVO article : boardList) {
                int wid = 0;
